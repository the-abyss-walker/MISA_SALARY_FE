...
const positionMap: Record<string, string> = {
  ...
  arrow_left: '-180px 0',
  check: '-120px -60px',
  radio_check: '-100px -20px',
  radio_uncheck: '-80px -20px',
  chevron_left: '-160px 0',
  chevron_right: '-140px 0',
  minus_circle: '-220px -40px',
  check_circle: '-180px -40px',
  copy: '-80px 0',
  pencil: '-60px 0',
  trash: '-120px -20px',
  close: '-280px 0',
  information: '-262px -42px',
  success: '-182px -42px',
  failed: '-242px -42px',
}
